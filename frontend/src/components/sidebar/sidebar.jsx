        ...
        <div className={`${side ? "w-[14%]" : "w-[3%]"}`}>
            {side ? (
                <div className="flex flex-col h-full overflow-y-auto overflow-x-hidden m-4">
                    ...
                    <hr className="m-4" />
                    <h1 className="font-semibold mb-4 ml-2">Explore</h1>
                    ...
                    <button className="flex items-center gap-4 p-2 rounded-xl hover:bg-gray-200 w-full">
                        <img src={trophy} alt="" className="w-7 rounded-full" />
                    ...
                    <button className="flex items-center gap-4 p-2 rounded-xl hover:bg-gray-200 w-full">
                        <img src={fashion} alt="" className="w-7 rounded-full" />
                        <p className="text-md ">Fashion and beauty</p>
                    </button>
                    <button className="flex items-center gap-4 p-2 rounded-xl hover:bg-gray-200 w-full">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                ...
                <div className="flex flex-col w-[3%] p-8 mr-14">
                    <button className="flex flex-col justify-center items-center gap-2 p-10 rounded-xl hover:bg-gray-200 w-full h-25">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
